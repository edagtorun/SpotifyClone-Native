      ...
      <ScrollView style={{marginTop:50}} contentContainerStyle={{paddingBottom:100}}>
        <View style={{padding:12}}>
          <View style={styles.profileContainer}>
           ...
           <Text style={styles.profileFollowers}>{formatFollowers(followers_count)} followers</Text>
           </View>
          </View>
        </View>
        ...
        <View style={styles.playlistContainer}>
          {public_playlists.map(playlist => (
              <View
              key={playlist.uri}
              style={{marginVertical:10, flexDirection:'row', alignItems:'center', gap:8}}>
              <Image source={{uri:'https://picsum.photos/200/300'}} 
              style={styles.playlistImage}/>
            <View>
              <Text style={{color:'white'}}>{playlist.name}</Text>
              <Text style={{color:'white', marginTop:7}}>{formatFollowers(playlist.followers_count)} followers</Text>
            </View>
            </View>
          ))}
        </View>
